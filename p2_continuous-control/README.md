...
The Unity environment contains 20 identical agents, each with its own copy of the environment. This allows the distribution of the task of gathering experience.
...
Follow the instructions in [Continuous_Control.ipynb](Continuous_Control.ipynb) and/or read the [report](report.md)  
